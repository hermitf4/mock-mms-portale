...
export class UsersService {
     ...
     */
    public getUsers(observe?: 'body', reportProgress?: boolean): Observable<Array<UserResponseDTO>>;
    public getUsers(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<UserResponseDTO>>>;
    public getUsers(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<UserResponseDTO>>>;
    public getUsers(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<UserResponseDTO>>(`${this.basePath}/getUsers`,
            {
